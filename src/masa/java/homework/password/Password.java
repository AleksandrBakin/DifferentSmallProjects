...
public class Password {
    public static void main(String[] args) throws InterruptedException,IOException {
        ...
        System.out.println("Password is valid:" + newSafePassword.safePassword);
    }
    ...
    public static class PasswordKeeper {
        ...
        public static String generateSafePassword() {
            ...
            StringBuilder newSafePassword = new StringBuilder();
            for (int i = 0; i < RANDOM_SAFE_PASSWORD_LENGTH; i++) {
                newSafePassword.append(randomSafePasswordCharsList.get(i));
            }
            return newSafePassword.toString();
        }
        ...
        public static String getPasswordAndCheck() throws IOException,InterruptedException {
            ...
            BufferedReader userPasswordReader = null;
            try {
                userPasswordReader = new BufferedReader(new InputStreamReader(System.in));
                while (true) {
                    userPassword = userPasswordReader.readLine();
                ...
                if (userPasswordReader != null) userPasswordReader.close();
            }
